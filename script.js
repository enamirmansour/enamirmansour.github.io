...
function loadTheme() {
 ...
 themeToggle.textContent = "☀️"; // خورشید برای تم تیره
 } else {
 themeToggle.textContent = "🌙"; // ماه برای تم روشن
 }
}

// بارگذاری تسک‌ها و تم موقع لود صفحه
loadTasks();
loadTheme();
...
themeToggle.addEventListener("click", function() {
 ...
 themeToggle.textContent = isDark ? "☀️" : "🌙"; // خورشید برای تیره، ماه برای روشن
